...
public class RoutinesFacade extends AbstractRepairRoutinesFacade {
  ...
  public boolean func1(final String string) {
    mir.routines.commonFunctions.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(tools.vitruv.extensions.dslsruntime.reactions.structure.ReactionsImportPath.fromPathString("commonFunctions"));
