...
public class RoutinesFacade extends mir.routines.commonFunctions.RoutinesFacade {
  ...
  public boolean func3() {
    mir.routines.extended.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(tools.vitruv.extensions.dslsruntime.reactions.structure.ReactionsImportPath.fromPathString("extended.base.commonFunctions").prepend(this._getParentImportPath()));
