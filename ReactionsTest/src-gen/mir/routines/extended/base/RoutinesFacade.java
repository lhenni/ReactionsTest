...
public class RoutinesFacade extends mir.routines.base.RoutinesFacade {
  ...
  public boolean test3(final java.util.List<java.lang.String> s) {
    mir.routines.extended.RoutinesFacade _routinesFacade = this._getRoutinesFacadesProvider().getRoutinesFacade(tools.vitruv.extensions.dslsruntime.reactions.structure.ReactionsImportPath.fromPathString("Extended.Base"));
