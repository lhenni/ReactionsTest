...
/**
 * 
 * nCreates the model for comparing the further test model with.
 *  
 */
...
public class CreateRootTestReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.simpleChangesRootTests.CreateRootTestReaction.ActionUserExecution userExecution = new mir.reactions.simpleChangesRootTests.CreateRootTestReaction.ActionUserExecution(this.executionState, this);
