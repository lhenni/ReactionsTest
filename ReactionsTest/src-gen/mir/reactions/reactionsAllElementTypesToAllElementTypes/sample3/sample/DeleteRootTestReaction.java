package mir.reactions.reactionsAllElementTypesToAllElementTypes.sample3.sample;
...
public class DeleteRootTestReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsAllElementTypesToAllElementTypes.sample3.sample.DeleteRootTestReaction.ActionUserExecution userExecution = new mir.reactions.reactionsAllElementTypesToAllElementTypes.sample3.sample.DeleteRootTestReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveRootEObject removeChange, final Root oldValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      _routinesFacade.sample2.sample.test();
