package mir.reactions.reactionsAllElementTypesToAllElementTypes.application.base;
...
public class CreateRootTestReaction extends AbstractReactionRealization {
  ...
  public CreateRootTestReaction(final RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.reactionsAllElementTypesToAllElementTypes.application.base.CreateRootTestReaction.ActionUserExecution userExecution = new mir.reactions.reactionsAllElementTypesToAllElementTypes.application.base.CreateRootTestReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertRootEObject insertChange, final Root newValue, final int index, @Extension final RoutinesFacade _routinesFacade) {
      ...
      _routinesFacade.someDummyRoutine();
    }
  }
}
