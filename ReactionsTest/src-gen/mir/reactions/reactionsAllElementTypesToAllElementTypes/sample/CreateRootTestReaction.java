package mir.reactions.reactionsAllElementTypesToAllElementTypes.sample;

import allElementTypes.Root;
import mir.routines.sample.RoutinesFacade;
...
public class CreateRootTestReaction extends AbstractReactionRealization {
  ...
  public CreateRootTestReaction(final AbstractReactionsExecutor executor) {
    super(executor);
  }
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.routines.sample.RoutinesFacade routinesFacade = executor.createRoutinesFacade("sample", this.executionState, this);
    mir.reactions.reactionsAllElementTypesToAllElementTypes.sample.CreateRootTestReaction.ActionUserExecution userExecution = new mir.reactions.reactionsAllElementTypesToAllElementTypes.sample.CreateRootTestReaction.ActionUserExecution(this.executionState, this);
